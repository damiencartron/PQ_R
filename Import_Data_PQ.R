...
PC18 <- read_sas("D:/Data/PratiqsKulles/pc18_quetelet_novembre2022.sas7bdat") %>%  as_tibble
...
formats <- read_delim("D:/Data/PratiqsKulles/Format_lil-1511_SAS.txt", 
...
saveRDS(PC18, "PC18_avec_labels.RDS")
